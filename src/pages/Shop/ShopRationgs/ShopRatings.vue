    ...
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        ...
        <div class="switch" :class="{on: onlyShowText}" @click="toggleOnlyShowText">
          <span class="iconfont icon-check_circle icon-fangkuangxuanzhong" ></span>
  ...
  computed:{
    ...
    filterRatings(){
      ...
      return ratings.filter(rating => {
        ...
        /**
         * 对每一个rating，过滤符合条件的实例，由于可能性比较多，需要依次分析
         * 条件1：
         *    selectType： 0/1/2   //组件中挑选
         *    rateType：0/1       //ratings中的值
